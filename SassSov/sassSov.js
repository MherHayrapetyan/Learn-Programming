...
class NewVideoDiv {
  constructor(num, src) {
    ...
    this.$div.innerHTML = `<div class="htmlSovBigBoxInformVideoOne">Sass - ${num} Վիդեոդաս</div>
...
for (a = 1; a <= 4; a++) {
  new NewVideoDiv(a, `https://www.youtube.com/watch?v=_SQKwV2hlJg&list=PLPENrJQeKNLbCorz6Ue8RGHiViQ3g28vP&index=${a}`)
  console.log(a)
}
